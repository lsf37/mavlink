...
goog.scope=function(a){a.call(goog.global)};goog.object={};goog.object.forEach=function(a,b,c){for(var d in a)b.call(c,a[d],d,a)};goog.object.filter=function(a,b,c){var d={},e;for(e in a)b.call(c,a[e],e,a)&&(d[e]=a[e]);return d};goog.object.map=function(a,b,c){var d={},e;for(e in a)d[e]=b.call(c,a[e],e,a);return d};goog.object.some=function(a,b,c){for(var d in a)if(b.call(c,a[d],d,a))return!0;return!1};goog.object.every=function(a,b,c){for(var d in a)if(!b.call(c,a[d],d,a))return!1;return!0};
...
goog.object.createImmutableView=function(a){var b=a;Object.isFrozen&&!Object.isFrozen(a)&&(b=Object.create(a),Object.freeze(b));return b};goog.object.isImmutableView=function(a){return!!Object.isFrozen&&Object.isFrozen(a)};var Mavelous={util:{}};Mavelous.util.heartbeat={};Mavelous.util.MavModeFlag={CUSTOM_MODE_ENABLED:1,TEST_ENABLED:2,AUTO_ENABLED:4,GUIDED_ENABLED:8,STABILIZE_ENABLED:16,HIL_ENABLED:32,MANUAL_INPUT_ENABLED:64,SAFETY_ARMED:128};Mavelous.util.MavType={FIXED_WING:1,QUADROTOR:2};Mavelous.util.ArduPlaneFlightModes={0:"MANUAL",1:"CIRCLE",2:"STABILIZE",5:"FBWA",6:"FBWB",7:"FBWC",10:"AUTO",11:"RTL",12:"LOITER",13:"TAKEOFF",14:"LAND",15:"GUIDED",16:"INITIALIZING"};
Mavelous.util.ArduCopterFlightModes={0:"STABILIZE",1:"ACRO",2:"ALT_HOLD",3:"AUTO",4:"GUIDED",5:"LOITER",6:"RTL",7:"CIRCLE",8:"POSITION",9:"LAND",10:"OF_LOITER",11:"APPROACH"};Mavelous.util.heartbeat.mavtype=function(a){a=a.get("type");return a==Mavelous.util.MavType.QUADROTOR?"ArduCopter":a==Mavelous.util.MavType.FIXED_WING?"ArduPlane":"unknown"};
Mavelous.util.heartbeat.modestring=function(a){var b=a.get("base_mode"),c=a.get("type");a=a.get("custom_mode");return null===b||null===c||null===a?"badmode":!b&Mavelous.util.MavModeFlag.CUSTOM_MODE_ENABLED?"BaseMode("+b+")":c==Mavelous.util.MavType.QUADROTOR&&goog.object.containsKey(Mavelous.util.ArduCopterFlightModes,a)?Mavelous.util.ArduCopterFlightModes[a]:c==Mavelous.util.MavType.FIXED_WING&&goog.object.containsKey(Mavelous.util.ArduPlaneFlightModes,a)?Mavelous.util.ArduPlaneFlightModes[a]:"CustomMode("+
a+")"};Mavelous.util.heartbeat.armed=function(a){a=a.get("base_mode");return null===a?null:a&Mavelous.util.MavModeFlag.SAFETY_ARMED?!0:!1};Mavelous.ModeStringView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.ModeStringView,Backbone.View);Mavelous.ModeStringView.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.$el=this.options.el;this.heartbeat=a.subscribe("HEARTBEAT",this.onHeartbeat,this)};goog.exportSymbol("Mavelous.ModeStringView.prototype.initialize",Mavelous.ModeStringView.prototype.initialize);
Mavelous.ModeStringView.prototype.onHeartbeat=function(){var a=Mavelous.util.heartbeat.modestring(this.heartbeat),b=Mavelous.util.heartbeat.armed(this.heartbeat);a&&this.$el.html(b?a+' <span class="ok">ARMED</span>':a+' <span class="slow">DISARMED</span>')};Mavelous.StatustextView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.StatustextView,Backbone.View);Mavelous.StatustextView.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.$el=$("#statustextview");this.statusText=a.subscribe("STATUSTEXT",this.onStatusTextChange,this);this.onStatusTextChange()};goog.exportSymbol("Mavelous.StatustextView.prototype.initialize",Mavelous.StatustextView.prototype.initialize);
Mavelous.StatustextView.prototype.onStatusTextChange=function(){clearTimeout(this.timeout);var a=this.$el;a.html(this.statusText.get("text"));a.css("padding",10);this.timeout=setTimeout(function(){a.html("");a.css("padding",0)},4E3)};Mavelous.GpsTextView={};Mavelous.GpsButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.GpsButtonView,Backbone.View);Mavelous.GpsButtonView.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.renderTemplate_();this.gps=a.subscribe("GPS_RAW_INT",this.onGPS_,this)};goog.exportSymbol("Mavelous.GpsButtonView.prototype.initialize",Mavelous.GpsButtonView.prototype.initialize);
Mavelous.GpsButtonView.prototype.renderTemplate_=function(){var a;a='<span class="hidden-phone">GPS: <span id="gps-btn-lock-status"></span>';a+="</span>";a+='<i class="icon-globe icon-white visible-phone"></i>';this.$el.html(a);this.$el.removeClass("btn-success btn-danger btn-warning btn-inverse");this.$el.addClass("btn-inverse")};
Mavelous.GpsButtonView.prototype.renderFixType_=function(a){this.$el.removeClass("btn-success btn-danger btn-warning btn-inverse");var b="btn-inverse",c="None";3<=a?(b="btn-success",c="3D"):2==a?(b="btn-warning",c="2D"):1==a&&(b="btn-danger",c="No Lock");this.$el.addClass(b);this.$el.find("#gps-btn-lock-status").text(c)};Mavelous.GpsButtonView.prototype.onGPS_=function(){var a=this.gps.get("fix_type");this.renderFixType_(a)};Mavelous.GpsPopoverViewDelegate=function(a){this.popoverTitle="GPS Info";Backbone.View.call(this,a)};goog.inherits(Mavelous.GpsPopoverViewDelegate,Backbone.View);Mavelous.GpsPopoverViewDelegate.prototype.initialize=function(){var a=this.options.mavlinkSrc;this.gps=a.subscribe("GPS_RAW_INT",this.render,this);this.stat=a.subscribe("GPS_STATUS",this.render,this)};Mavelous.GpsPopoverViewDelegate.prototype.popoverCreated=function(a){this.$el=a;this.$el.find(".popover-title").text(this.popoverTitle);this.render()};
Mavelous.GpsPopoverViewDelegate.prototype.popoverDestroyed=function(){this.$el=null};
Mavelous.GpsPopoverViewDelegate.prototype.render=function(){if(this.$el){var a=this.stat.toJSON(),b=(this.gps.get("lat")/1E7).toFixed(7),c=(this.gps.get("lon")/1E7).toFixed(7),d="";"satellites_visible"in a&&(d+="Satellites: "+a.satellites_visible.toString()+"<br /> Coordinates: "+b+", "+c);a=this.gps.get("eph");"undefined"!=typeof a&&65535!=a&&(d+="<br />HDOP: "+(a/100).toFixed(2)+"m");a=this.gps.get("epv");"undefined"!=typeof a&&65535!=a&&(d+="<br />VDOP: "+(a/100).toFixed(2)+"m");this.$el.find(".popover-content").html(d)}};Mavelous.SelectionModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.SelectionModel,Backbone.Model);Mavelous.SelectionModel.prototype.defaults=function(){return{selected:!1}};goog.exportSymbol("Mavelous.SelectionModel.prototype.defaults",Mavelous.SelectionModel.prototype.defaults);
Mavelous.PopoverView=function(a){this.template='<div class="popover"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>';Backbone.View.call(this,a)};goog.inherits(Mavelous.PopoverView,Backbone.View);
Mavelous.PopoverView.prototype.initialize=function(){this.$el=null;this.btn=this.options.btn;this.placement=this.options.placement||"bottom";this.delegate=this.options.delegate;this.selectionModel=new Mavelous.SelectionModel;this.radioBtnController=this.options.radioBtnController;this.selectionModel.bind("change",this.onSelectionChange_,this);this.btn.$el.click(goog.bind(this.radioBtnController.onButtonClick,this.radioBtnController,this))};
goog.exportSymbol("Mavelous.PopoverView.prototype.initialize",Mavelous.PopoverView.prototype.initialize);Mavelous.PopoverView.prototype.select=function(){this.selectionModel.set("selected",!0)};Mavelous.PopoverView.prototype.deselect=function(){this.selectionModel.set("selected",!1)};Mavelous.PopoverView.prototype.selected=function(){return this.selectionModel.get("selected")};
Mavelous.PopoverView.prototype.onSelectionChange_=function(){if(this.selectionModel.get("selected")){this.createElement();var a=this.$el.find(".popover-inner");this.delegate.popoverCreated(a)}else this.delegate.popoverDestroyed(),this.destroyElement()};Mavelous.PopoverView.prototype.createElement=function(){this.$el=$(this.template);this.$el.removeClass("fade top bottom left right in");this.$el.remove().css({top:0,left:0,display:"block"}).appendTo(document.body);this.$el.css(this.placementStyle(this.placement)).addClass(this.placement).addClass("in")};
Mavelous.PopoverView.prototype.placementStyle=function(a){var b=$.extend({},this.btn.$el.offset(),{width:this.btn.$el[0].offsetWidth,height:this.btn.$el[0].offsetHeight}),c=this.$el[0].offsetWidth,d=this.$el[0].offsetHeight;switch(a){case "bottom":return{top:b.top+b.height,left:b.left+b.width/2-c/2};case "top":return{top:b.top-d,left:b.left+b.width/2-c/2};case "left":return{top:b.top+b.height/2-d/2,left:b.left-c};case "right":return{top:b.top+b.height/2-d/2,left:b.left+b.width}}};
Mavelous.PopoverView.prototype.destroyElement=function(){this.$el&&this.$el.remove()};Mavelous.BatteryButton=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.BatteryButton,Backbone.View);Mavelous.BatteryButton.prototype.initialize=function(){this.sysstatus=this.options.mavlinkSrc.subscribe("SYS_STATUS",this.onSysStatus,this);this.$el=this.options.el};goog.exportSymbol("Mavelous.BatteryButton.prototype.initialize",Mavelous.BatteryButton.prototype.initialize);
Mavelous.BatteryButton.prototype.onSysStatus=function(){var a=this.sysstatus,b=a.get("battery_remaining"),a=a.get("voltage_battery");30>b?this.setButton_("btn-warning",b.toFixed(0)+"%"):20>b?this.setButton_("btn-danger",b.toFixed(0)+"% "+a.toFixed(1)+"v"):void 0===b?this.setButton_("btn-inverse","Unknown"):this.setButton_("btn-success",b.toFixed(0)+"%")};
Mavelous.BatteryButton.prototype.setButton_=function(a,b){this.$el.removeClass("btn-success btn-warning btn-danger btn-inverse");this.$el.addClass(a);var c;c='<span class="hidden-phone">Batt: '+b+'</span><i class="icon-fire icon-white visible-phone"></i>';this.$el.html(c)};Mavelous.LeafletPanControlView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.LeafletPanControlView,Backbone.View);Mavelous.LeafletPanControlView.prototype.initialize=function(){this.button=this.options.button;this.icon=this.options.icon;this.button.click(goog.bind(this.onClick,this));this.model.on("change:tracking",this.onTrackingChange,this);this.onTrackingChange()};goog.exportSymbol("Mavelous.LeafletPanControlView.prototype.initialize",Mavelous.LeafletPanControlView.prototype.initialize);
Mavelous.LeafletPanControlView.prototype.onClick=function(){this.model.get("tracking")?this.model.set("tracking",!1):this.model.set("tracking",!0)};Mavelous.LeafletPanControlView.prototype.onTrackingChange=function(){this.model.get("tracking")?(this.button.addClass("btn-primary"),this.icon.removeClass("icon-black"),this.icon.addClass("icon-white")):(this.button.removeClass("btn-primary"),this.icon.removeClass("icon-white"),this.icon.addClass("icon-black"))};
Mavelous.LeafletPanModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.LeafletPanModel,Backbone.Model);Mavelous.LeafletPanModel.prototype.defaults=function(){return{initialized:!1,tracking:!0,center:void 0}};goog.exportSymbol("Mavelous.LeafletPanModel.prototype.defaults",Mavelous.LeafletPanModel.prototype.defaults);Mavelous.LeafletPanModel.prototype.initialize=function(){this.vehicle=this.get("vehicle");this.vehicle.on("change",this.onVehicleChange_,this)};
goog.exportSymbol("Mavelous.LeafletPanModel.prototype.initialize",Mavelous.LeafletPanModel.prototype.initialize);Mavelous.LeafletPanModel.prototype.onVehicleChange_=function(){var a=this.vehicle.get("position");this.get("initialized")?this.get("tracking")&&a&&a.lat&&a.lng&&this.set({center:a}):a&&a.lat&&a.lng&&this.set({center:a,initialized:!0})};Mavelous.LeafletPanModel.prototype.cancelTracking=function(){this.set("tracking",!1)};goog.disposable={};goog.disposable.IDisposable=function(){};goog.Disposable=function(){goog.Disposable.MONITORING_MODE!=goog.Disposable.MonitoringMode.OFF&&(this.creationStack=Error().stack,goog.Disposable.instances_[goog.getUid(this)]=this)};goog.Disposable.MonitoringMode={OFF:0,PERMANENT:1,INTERACTIVE:2};goog.Disposable.MONITORING_MODE=0;goog.Disposable.instances_={};goog.Disposable.getUndisposedObjects=function(){var a=[],b;for(b in goog.Disposable.instances_)goog.Disposable.instances_.hasOwnProperty(b)&&a.push(goog.Disposable.instances_[Number(b)]);return a};
...
goog.events.Listener.prototype.handleEvent=function(a){return this.isFunctionListener_?this.listener.call(this.handler||this.src,a):this.listener.handleEvent.call(this.listener,a)};goog.debug={};goog.debug.errorHandlerWeakDep={protectEntryPoint:function(a,b){return a}};goog.string={};goog.string.Unicode={NBSP:"\u00a0"};goog.string.startsWith=function(a,b){return 0==a.lastIndexOf(b,0)};goog.string.endsWith=function(a,b){var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c};goog.string.caseInsensitiveStartsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(0,b.length))};goog.string.caseInsensitiveEndsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(a.length-b.length,b.length))};
...
goog.string.compareVersions=function(a,b){for(var c=0,d=goog.string.trim(String(a)).split("."),e=goog.string.trim(String(b)).split("."),f=Math.max(d.length,e.length),g=0;0==c&&g<f;g++){var h=d[g]||"",k=e[g]||"",l=RegExp("(\\d*)(\\D*)","g"),n=RegExp("(\\d*)(\\D*)","g");do{var p=l.exec(h)||["","",""],m=n.exec(k)||["","",""];if(0==p[0].length&&0==m[0].length)break;var c=0==p[1].length?0:parseInt(p[1],10),q=0==m[1].length?0:parseInt(m[1],10),c=goog.string.compareElements_(c,q)||goog.string.compareElements_(0==
p[2].length,0==m[2].length)||goog.string.compareElements_(p[2],m[2])}while(0==c)}return c};goog.string.compareElements_=function(a,b){return a<b?-1:a>b?1:0};goog.string.HASHCODE_MAX_=4294967296;goog.string.hashCode=function(a){for(var b=0,c=0;c<a.length;++c)b=31*b+a.charCodeAt(c),b%=goog.string.HASHCODE_MAX_;return b};goog.string.uniqueStringCounter_=2147483648*Math.random()|0;goog.string.createUniqueString=function(){return"goog_"+goog.string.uniqueStringCounter_++};
...
goog.userAgent.isDocumentMode=function(a){return goog.userAgent.IE&&goog.userAgent.DOCUMENT_MODE>=a};goog.userAgent.DOCUMENT_MODE=function(){var a=goog.global.document;return a&&goog.userAgent.IE?goog.userAgent.getDocumentMode_()||("CSS1Compat"==a.compatMode?parseInt(goog.userAgent.VERSION,10):5):void 0}();goog.events.BrowserFeature={HAS_W3C_BUTTON:!goog.userAgent.IE||goog.userAgent.isDocumentMode(9),HAS_W3C_EVENT_SUPPORT:!goog.userAgent.IE||goog.userAgent.isDocumentMode(9),SET_KEY_CODE_TO_PREVENT_DEFAULT:goog.userAgent.IE&&!goog.userAgent.isVersion("9"),HAS_NAVIGATOR_ONLINE_PROPERTY:!goog.userAgent.WEBKIT||goog.userAgent.isVersion("528"),HAS_HTML5_NETWORK_EVENT_SUPPORT:goog.userAgent.GECKO&&goog.userAgent.isVersion("1.9b")||goog.userAgent.IE&&goog.userAgent.isVersion("8")||goog.userAgent.OPERA&&goog.userAgent.isVersion("9.5")||
...
goog.events.handleBrowserEvent_=function(a,b){if(!goog.events.listeners_[a])return!0;var c=goog.events.listeners_[a],d=c.type,e=goog.events.listenerTree_;if(!(d in e))return!0;var e=e[d],f,g;if(!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT){f=b||goog.getObjectByName("window.event");var h=!0 in e,k=!1 in e;if(h){if(goog.events.isMarkedIeEvent_(f))return!0;goog.events.markIeEvent_(f)}var l=new goog.events.BrowserEvent;l.init(f,this);f=!0;try{if(h){for(var n=[],p=l.currentTarget;p;p=p.parentNode)n.push(p);
g=e[!0];g.remaining_=g.count_;for(var m=n.length-1;!l.propagationStopped_&&0<=m&&g.remaining_;m--)l.currentTarget=n[m],f&=goog.events.fireListeners_(g,n[m],d,!0,l);if(k)for(g=e[!1],g.remaining_=g.count_,m=0;!l.propagationStopped_&&m<n.length&&g.remaining_;m++)l.currentTarget=n[m],f&=goog.events.fireListeners_(g,n[m],d,!1,l)}else f=goog.events.fireListener(c,l)}finally{n&&(n.length=0)}return f}d=new goog.events.BrowserEvent(b,this);return f=goog.events.fireListener(c,d)};
...
goog.Timer.TICK="tick";goog.Timer.callOnce=function(a,b,c){if(goog.isFunction(a))c&&(a=goog.bind(a,c));else if(a&&"function"==typeof a.handleEvent)a=goog.bind(a.handleEvent,a);else throw Error("Invalid listener argument");return b>goog.Timer.MAX_TIMEOUT_?-1:goog.Timer.defaultTimerObject.setTimeout(a,b||0)};goog.Timer.clear=function(a){goog.Timer.defaultTimerObject.clearTimeout(a)};goog.async={};goog.async.Throttle=function(a,b,c){goog.Disposable.call(this);this.listener_=a;this.interval_=b;this.handler_=c;this.callback_=goog.bind(this.onTimer_,this)};goog.inherits(goog.async.Throttle,goog.Disposable);goog.Throttle=goog.async.Throttle;goog.async.Throttle.prototype.shouldFire_=!1;goog.async.Throttle.prototype.pauseCount_=0;goog.async.Throttle.prototype.timer_=null;goog.async.Throttle.prototype.fire=function(){this.timer_||this.pauseCount_?this.shouldFire_=!0:this.doAction_()};
...
goog.async.Throttle.prototype.onTimer_=function(){this.timer_=null;this.shouldFire_&&!this.pauseCount_&&(this.shouldFire_=!1,this.doAction_())};goog.async.Throttle.prototype.doAction_=function(){this.timer_=goog.Timer.callOnce(this.callback_,this.interval_);this.listener_.call(this.handler_)};Mavelous.CommStatusModel=function(a){this.SERVER_TIMEOUT_INTERVAL=3E3;this.HEARTBEAT_TIMEOUT_INTERVAL=2E3;Backbone.Model.call(this,a)};goog.inherits(Mavelous.CommStatusModel,Backbone.Model);Mavelous.CommStatusModel.State={UNINITIALIZED:0,OK:1,TIMED_OUT_ONCE:2,TIMED_OUT_MANY:3,ERROR:4};Mavelous.CommStatusModel.prototype.defaults=function(){return{mav:Mavelous.CommStatusModel.State.UNINITIALIZED,server:Mavelous.CommStatusModel.State.UNINITIALIZED}};
goog.exportSymbol("Mavelous.CommStatusModel.prototype.defaults",Mavelous.CommStatusModel.prototype.defaults);Mavelous.CommStatusModel.prototype.initialize=function(){var a=this.get("mavlinkSrc");a.subscribe("HEARTBEAT",this.onHeartbeat,this);a.on("gotServerResponse",this.onServerSuccess,this);a.on("gotServerError",this.onServerError,this);this.resetServerTimeout()};goog.exportSymbol("Mavelous.CommStatusModel.prototype.initialize",Mavelous.CommStatusModel.prototype.initialize);
Mavelous.CommStatusModel.prototype.onHeartbeat=function(){this.set("mav",Mavelous.CommStatusModel.State.OK);this.resetHeartbeatTimeout()};Mavelous.CommStatusModel.prototype.resetHeartbeatTimeout=function(){var a=this;clearTimeout(this.heartbeatTimeout);this.heartbeatTimeout=setTimeout(function(){a.onHeartbeatTimeout()},this.HEARTBEAT_TIMEOUT_INTERVAL)};
Mavelous.CommStatusModel.prototype.onHeartbeatTimeout=function(){var a=this.get("mav");a===Mavelous.CommStatusModel.State.OK?this.set("mav",Mavelous.CommStatusModel.State.TIMED_OUT_ONCE):a===Mavelous.CommStatusModel.State.TIMED_OUT_ONCE&&this.set("mav",Mavelous.CommStatusModel.State.TIMED_OUT_MANY);this.resetHeartbeatTimeout()};Mavelous.CommStatusModel.prototype.onServerSuccess=function(){this.set("server",Mavelous.CommStatusModel.State.OK);this.resetServerTimeout()};
Mavelous.CommStatusModel.prototype.onServerError=function(){this.set("server",Mavelous.CommStatusModel.State.ERROR)};Mavelous.CommStatusModel.prototype.resetServerTimeout=function(){var a=this;clearTimeout(this.serverTimeout);this.serverTimeout=setTimeout(function(){a.onServerTimeout()},this.SERVER_TIMEOUT_INTERVAL)};
Mavelous.CommStatusModel.prototype.onServerTimeout=function(){var a=this.get("server");a===Mavelous.CommStatusModel.State.OK?this.set("server",Mavelous.CommStatusModel.State.TIMED_OUT_ONCE):a===Mavelous.CommStatusModel.State.TIMED_OUT_ONCE&&this.set("server",Mavelous.CommStatusModel.State.TIMED_OUT_MANY);this.resetServerTimeout()};Mavelous.PacketLossModel=function(a){this.period=10;Backbone.Model.call(this,a)};goog.inherits(Mavelous.PacketLossModel,Backbone.Model);
Mavelous.PacketLossModel.prototype.defaults=function(){return{history:[],current:-1}};goog.exportSymbol("Mavelous.PacketLossModel.prototype.defaults",Mavelous.PacketLossModel.prototype.defaults);Mavelous.PacketLossModel.prototype.initialize=function(){this.metalinkquality=this.get("mavlinkSrc").subscribe("META_LINKQUALITY",this.onMessage,this)};goog.exportSymbol("Mavelous.PacketLossModel.prototype.initialize",Mavelous.PacketLossModel.prototype.initialize);
Mavelous.PacketLossModel.prototype.onMessage=function(){var a=this.get("history"),b=this.get("current"),c=this.metalinkquality.toJSON(),b=(b+1)%(this.period+1);a[b]=c;this.set("history",a);this.set("current",b)};Mavelous.PacketLossModel.prototype.getDelta=function(){var a=this.get("history"),b=this.get("current");if(0>b)return null;var c=a[(b+1)%(this.period+1)];return c?this.diff(a[b],c,this.period):this.diff(a[b],a[0],b)};
Mavelous.PacketLossModel.prototype.diff=function(a,b,c){return{master_in:a.master_in-b.master_in,master_out:a.master_out-b.master_out,mav_loss:a.mav_loss-b.mav_loss,period:c}};Mavelous.CommStatusButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.CommStatusButtonView,Backbone.View);Mavelous.CommStatusButtonView.prototype.initialize=function(){this.commStatusModel=this.options.commStatusModel;this.commStatusModel.bind("change",this.buttonRender,this)};
goog.exportSymbol("Mavelous.CommStatusButtonView.prototype.initialize",Mavelous.CommStatusButtonView.prototype.initialize);
Mavelous.CommStatusButtonView.prototype.buttonRender=function(){var a=this.commStatusModel.toJSON(),b=a.server,a=a.mav,c=Mavelous.CommStatusModel.State.UNINITIALIZED,d=Mavelous.CommStatusModel.State.OK,e=Mavelous.CommStatusModel.State.TIMED_OUT_ONCE,f=Mavelous.CommStatusModel.State.TIMED_OUT_MANY,g=Mavelous.CommStatusModel.State.ERROR;b===d&&a===d?this.setButton(d):b===c||a===c?this.setButton(c):b===f||a===f?this.setButton(f):b===e||a===e?this.setButton(e):b===g||a===g?this.setButton(g):goog.asserts.assert(!1,
"Unknown comm status: "+b+"/"+a)};
Mavelous.CommStatusButtonView.prototype.setButton=function(a){this.$el.removeClass("btn-success btn-danger btn-warning btn-inverse ");var b="Link: None",c="btn-inverse";a===Mavelous.CommStatusModel.State.UNINITIALIZED?(c="btn-inverse",b="Link: None"):a===Mavelous.CommStatusModel.State.OK?(c="btn-success",b="Link: Good"):a===Mavelous.CommStatusModel.State.TIMED_OUT_ONCE?(c="btn-warning",b="Link: Lost"):a===Mavelous.CommStatusModel.State.TIMED_OUT_MANY?(c="btn-danger",b="Link: Lost"):(c="btn-danger",
b="Link: Error");this.$el.addClass(c);b='<span class="hidden-phone">'+b+'</span><i class="icon-signal icon-white visible-phone"></i>';this.$el.html(b)};goog.dom={};goog.dom.classes={};goog.dom.classes.set=function(a,b){a.className=b};goog.dom.classes.get=function(a){a=a.className;return goog.isString(a)&&a.match(/\S+/g)||[]};goog.dom.classes.add=function(a,b){var c=goog.dom.classes.get(a),d=goog.array.slice(arguments,1),e=c.length+d.length;goog.dom.classes.add_(c,d);a.className=c.join(" ");return c.length==e};
...
goog.dom.DomHelper.prototype.isNodeList=goog.dom.isNodeList;goog.dom.DomHelper.prototype.getAncestorByTagNameAndClass=goog.dom.getAncestorByTagNameAndClass;goog.dom.DomHelper.prototype.getAncestorByClass=goog.dom.getAncestorByClass;goog.dom.DomHelper.prototype.getAncestor=goog.dom.getAncestor;/*
 Portions of this code are from MochiKit, received by
 The Closure Authors under the MIT license. All other code is Copyright
 2005-2009 The Closure Authors. All Rights Reserved.
*/
goog.async.Deferred=function(a,b){this.sequence_=[];this.onCancelFunction_=a;this.defaultScope_=b||null};goog.async.Deferred.prototype.fired_=!1;goog.async.Deferred.prototype.hadError_=!1;goog.async.Deferred.prototype.blocked_=!1;goog.async.Deferred.prototype.blocking_=!1;goog.async.Deferred.prototype.silentlyCancelled_=!1;goog.async.Deferred.prototype.branches_=0;
...
goog.net.jsloader.Error=function(a,b){var c="Jsloader error (code #"+a+")";b&&(c+=": "+b);goog.debug.Error.call(this,c);this.code=a};goog.inherits(goog.net.jsloader.Error,goog.debug.Error);Mavelous.LeafletDroneIconModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.LeafletDroneIconModel,Backbone.Model);Mavelous.LeafletDroneIconModel.prototype.defaults=function(){return{icon:"predatorsmall"}};goog.exportSymbol("Mavelous.LeafletDroneIconModel.prototype.defaults",Mavelous.LeafletDroneIconModel.prototype.defaults);Mavelous.LeafletDroneIconModel.prototype.getIcon=function(){var a=this.get("icon");return new Mavelous.LeafletDroneIconModel.Icons[a].constructor};
Mavelous.LeafletDroneIconModel.Icons={predatorsmall:{description:"Predator (small)",constructor:L.Icon.extend({options:{iconUrl:"image/drone-tiny.png",shadowUrl:null,iconAnchor:new L.Point(37,25),iconSize:new L.Point(75,50)}})},predator:{description:"Predator",constructor:L.Icon.extend({options:{iconUrl:"image/drone-sm.png",shadowUrl:null,iconAnchor:new L.Point(75,50),iconSize:new L.Point(150,100)}})},arduplane:{description:"Generic Airplane",constructor:L.Icon.extend({options:{iconUrl:"image/plane.png",
shadowUrl:null,iconAnchor:new L.Point(36,38),iconSize:new L.Point(73,76)}})},quad:{description:"Quadcopter",constructor:L.Icon.extend({options:{iconUrl:"image/quad.png",shadowUrl:null,iconAnchor:new L.Point(37,37),iconSize:new L.Point(75,75)}})}};Mavelous.FlightModePopoverViewDelegate=function(a){this.popoverTitle="Flight Commands";Backbone.View.call(this,a)};goog.inherits(Mavelous.FlightModePopoverViewDelegate,Backbone.View);Mavelous.FlightModePopoverViewDelegate.prototype.initialize=function(){this.modeModel=this.options.modeModel;this.commandModel=this.options.commandModel};goog.exportSymbol("Mavelous.FlightModePopoverViewDelegate.prototype.initialize",Mavelous.FlightModePopoverViewDelegate.prototype.initialize);
Mavelous.FlightModePopoverViewDelegate.prototype.popoverCreated=function(a){this.$el=a;this.$el.find(".popover-title").text(this.popoverTitle);this.setupPopover()};Mavelous.FlightModePopoverViewDelegate.prototype.popoverDestroyed=function(){this.$el=null;this.cleanupSubview("armingButtonView");this.cleanupSubview("loiterButtonView");this.cleanupSubview("rtlButtonView");this.cleanupSubview("landButtonView")};
Mavelous.FlightModePopoverViewDelegate.prototype.setupPopover=function(){this.$el.find(".popover-content").html('<p><a class="btn" id="flightmode-btn-arm" href="#">Arm</a></p><br /><a class="btn" id="flightmode-btn-loiter" href="#">Loiter</a><a class="btn" id="flightmode-btn-rtl" href="#">RTL</a><a class="btn" id="flightmode-btn-land" href="#">Land</a>');this.armingButtonView=new Mavelous.ArmingButtonView({el:$("#flightmode-btn-arm"),model:this.modeModel});this.loiterButtonView=new Mavelous.CommandButtonView({el:$("#flightmode-btn-loiter"),
model:this.commandModel,command:"NAV_LOITER_UNLIM"});this.rtlButtonView=new Mavelous.CommandButtonView({el:$("#flightmode-btn-rtl"),model:this.commandModel,command:"NAV_RETURN_TO_LAUNCH"});this.landButtonView=new Mavelous.CommandButtonView({el:$("#flightmode-btn-land"),model:this.commandModel,command:"NAV_LAND"})};Mavelous.FlightModePopoverViewDelegate.prototype.cleanupSubview=function(a){this[a]&&(this[a].remove(),this[a]=null)};Mavelous.AppRouter=function(a){this.pfdSettingsModel=a.pfdSettingsModel;this.routes={overview:"route_overview",fullpfd:"route_fullpfd",maponly:"route_maponly"};Backbone.Router.call(this,a)};goog.inherits(Mavelous.AppRouter,Backbone.Router);Mavelous.AppRouter.prototype.initialize=function(a){var b={};_.each(this.routes,function(a,d){var e=$("#navbar-"+d);0<e.length&&(b[d]=e)});this.navbar=b};goog.exportSymbol("Mavelous.AppRouter.prototype.initialize",Mavelous.AppRouter.prototype.initialize);
Mavelous.AppRouter.prototype.route_overview=function(){this.setnavbar("overview");this.pfdSettingsModel.set({size:Mavelous.PFDSettingsModel.Size.STANDARD})};goog.exportSymbol("Mavelous.AppRouter.prototype.route_overview",Mavelous.AppRouter.prototype.route_overview);Mavelous.AppRouter.prototype.route_fullpfd=function(){this.setnavbar("fullpfd");this.pfdSettingsModel.set({size:Mavelous.PFDSettingsModel.Size.FULLSCREEN})};goog.exportSymbol("Mavelous.AppRouter.prototype.route_fullpfd",Mavelous.AppRouter.prototype.route_fullpfd);
Mavelous.AppRouter.prototype.route_maponly=function(){this.setnavbar("maponly");this.pfdSettingsModel.set({size:Mavelous.PFDSettingsModel.Size.HIDDEN})};goog.exportSymbol("Mavelous.AppRouter.prototype.route_maponly",Mavelous.AppRouter.prototype.route_maponly);Mavelous.AppRouter.prototype.setnavbar=function(a){_.each(this.navbar,function(a){a.removeClass("active")});this.navbar[a].addClass("active")};Mavelous.ArtificialHorizon=function(a){this.initArtificialHorizon_(a);Kinetic.Shape.call(this,a)};goog.inherits(Mavelous.ArtificialHorizon,Kinetic.Shape);Mavelous.ArtificialHorizon.prototype.initArtificialHorizon_=function(a){Kinetic.Shape.call(this,a);this.setAttrs({width:100,height:100,skyColor:"#72cde4",groundColor:"#323232",lineColor:"#ffffff",planeColor:"black"});this.shapeType="ArtificialHorizon";this.radius=Math.min(a.width,a.height)/2;this.roll=this.pitch=0;this._setDrawFuncs()};
Mavelous.ArtificialHorizon.prototype.drawFunc=function(a){a=a.getContext();var b=this.getHorizon_(this.pitch),c=this.getAttrs(),d=c.width,e=c.height;a.translate(d/2,e/2);a.save();a.beginPath();a.rect(-d/2,-e/2,d,e);a.clip();a.rotate(-this.roll);a.fillStyle=c.groundColor;a.strokeStyle=c.lineColor;a.lineWidth=3;a.beginPath();a.rect(-d,b,2*d,e);a.fill();a.fillStyle=c.skyColor;a.beginPath();a.rect(-d,-e,2*d,e+b);a.fill();a.lineWidth=1;a.beginPath();a.moveTo(-d/2,b);a.lineTo(d/2,b);a.stroke();this.drawPitchRung_(a,
30,0.3*d);this.drawPitchRung_(a,25,0.05*d);this.drawPitchRung_(a,20,0.2*d);this.drawPitchRung_(a,15,0.05*d);this.drawPitchRung_(a,10,0.1*d);this.drawPitchRung_(a,5,0.05*d);b=0.9*this.radius;a.beginPath();a.arc(0,0,b,210*Math.PI/180,330*Math.PI/180,!1);a.stroke();this.drawRollRung_(a,210*Math.PI/180,10,b);this.drawRollRung_(a,220*Math.PI/180,5,b);this.drawRollRung_(a,230*Math.PI/180,10,b);this.drawRollRung_(a,240*Math.PI/180,5,b);this.drawRollRung_(a,250*Math.PI/180,5,b);this.drawRollRung_(a,260*Math.PI/
180,5,b);this.drawTriangle_(a,270*Math.PI/180,5,b,!0);this.drawRollRung_(a,280*Math.PI/180,5,b);this.drawRollRung_(a,290*Math.PI/180,5,b);this.drawRollRung_(a,300*Math.PI/180,5,b);this.drawRollRung_(a,310*Math.PI/180,10,b);this.drawRollRung_(a,320*Math.PI/180,5,b);this.drawRollRung_(a,330*Math.PI/180,10,b);a.restore();this.drawTriangle_(a,270*Math.PI/180,-5,b,!1);a.strokeStyle=c.planeColor;a.lineWidth=3;a.beginPath();a.moveTo(-30,-1);a.lineTo(-10,-1);a.lineTo(-5,5);a.stroke();a.beginPath();a.moveTo(30,
-1);a.lineTo(10,-1);a.lineTo(5,5);a.stroke()};goog.exportSymbol("Mavelous.ArtificialHorizon.prototype.drawFunc",Mavelous.ArtificialHorizon.prototype.drawFunc);
Mavelous.ArtificialHorizon.prototype.drawTriangle_=function(a,b,c,d,e){Math.cos(b);Math.sin(b);var f=2*Math.PI/180,g=this.getAttrs();a.lineWidth=1;a.strokeStyle=g.lineColor;a.beginPath();a.moveTo(d*Math.cos(b),d*Math.sin(b));a.lineTo((d+c)*Math.cos(b+f),(d+c)*Math.sin(b+f));a.lineTo((d+c)*Math.cos(b-f),(d+c)*Math.sin(b-f));a.lineTo(d*Math.cos(b),d*Math.sin(b));a.stroke();e&&(a.fillStyle=g.lineColor,a.fill())};
Mavelous.ArtificialHorizon.prototype.drawRollRung_=function(a,b,c,d){var e=Math.cos(b);b=Math.sin(b);var f=this.getAttrs();a.lineWidth=1;a.strokeStyle=f.lineColor;a.beginPath();a.moveTo(e*d,b*d);a.lineTo(e*(d+c),b*(d+c));a.stroke()};
Mavelous.ArtificialHorizon.prototype.drawPitchRung_=function(a,b,c){var d=this.getAttrs();a.lineWidth=1;a.strokeStyle=d.lineColor;d=this.getHorizon_(this.pitch+b*Math.PI/180);a.beginPath();a.moveTo(-c/2,d);a.lineTo(c/2,d);a.stroke();d=this.getHorizon_(this.pitch-b*Math.PI/180);a.beginPath();a.moveTo(-c/2,d);a.lineTo(c/2,d);a.stroke()};Mavelous.ArtificialHorizon.prototype.getHorizon_=function(a){return Math.sin(a)*this.radius};
Mavelous.ArtificialHorizon.prototype.setPitchRoll=function(a,b){this.pitch=a;this.roll=b};Mavelous.Tape=function(a){Kinetic.Shape.call(this,a);this.initTape_(a)};goog.inherits(Mavelous.Tape,Kinetic.Shape);Mavelous.Tape.WIDTH=30;Mavelous.Tape.HEIGHT=140;
Mavelous.Tape.prototype.initTape_=function(a){var b=Mavelous.Tape.WIDTH,c=Mavelous.Tape.HEIGHT;this.setAttrs({backgroundColor:void 0,width:b,height:c,fontFamily:"Calibri",fontSize:12,fontStyle:"normal",side:Mavelous.Tape.SideType.LEFT});this.value=0;this.targetValue=null;this.valueText="0";Kinetic.Shape.call(this,a);this._setDrawFuncs();this.instantaneousPolygon=new Kinetic.Polygon({points:this.reflect_([0,60*c/140,25*b/30,60*c/140,b,c/2,25*b/30,80*c/140,0,80*c/140,0,60*c/140]),stroke:a.fontColor,
strokeWidth:1,fill:a.instantaneousBackgroundColor});this.bug=new Kinetic.Polygon({x:0,y:0,points:this.reflect_([31*b/30,0,34*b/30,-2*c/140,36*b/30,-2*c/140,36*b/30,2*c/140,34*b/30,2*c/140,31*b/30,0]),stroke:a.bugColor,fill:a.bugColor,strokeWidth:1})};Mavelous.Tape.prototype.reflect1_=function(a){var b=this.getAttrs();return b.side===Mavelous.Tape.SideType.RIGHT?b.width-a:a};
Mavelous.Tape.prototype.reflect_=function(a){var b=this.getAttrs();if(b.side===Mavelous.Tape.SideType.RIGHT)for(var b=b.width,c=a.length,d=0;d<c;d+=2)a[d]=b-a[d];return a};Mavelous.Tape.prototype.setValue=function(a){if(a!=this.value){this.value=a;var b="ERR";goog.isDefAndNotNull(a)&&(b=a.toString());3<b.length&&(b=b.substring(0,3),"."==b.charAt(b.length-1)&&(b=b.substr(0,b.length-1)));this.valueText=b}};Mavelous.Tape.prototype.setTargetValue=function(a){this.targetValue=a};
Mavelous.Tape.prototype.drawFunc=function(a){var b=a.getContext(),c=Mavelous.Tape.WIDTH,d=Mavelous.Tape.HEIGHT,e=this.getAttrs();goog.isDefAndNotNull(e.backgroundColor)&&(b.beginPath(),b.fillStyle=e.backgroundColor,b.rect(0,0,30,140),b.closePath(),this.fillStroke(b));var f=this.value-d/4,f=2*Math.ceil(f/2),f=Math.max(0,f),g=this.value+d/4,g=2*Math.floor(g/2),h="normal "+0.9*e.fontSize+"pt "+e.fontFamily;b.font=h;b.fillStyle=e.fontColor;b.strokeStyle=e.fontColor;b.textBaseLine="top";b.textAlign=e.side===
Mavelous.Tape.SideType.LEFT?"right":"left";for(h=e.fontSize/2;f<=g;f+=2){var k=d/2+2*(this.value-f);if(0.001>f%10||0.001>10-f%10){b.beginPath();b.moveTo(this.reflect1_(25*c/30),k);b.lineTo(this.reflect1_(c),k);b.stroke();var l=""+Math.round(f);b.beginPath();b.fillText(l,this.reflect1_(23*c/30),k+h)}else b.beginPath(),b.moveTo(this.reflect1_(28*c/30),k),b.lineTo(this.reflect1_(c),k),b.stroke()}this.instantaneousPolygon.drawFunc(a);b=a.getContext();d=e.height/2;h="normal "+e.fontSize+"pt "+e.fontFamily;
b.font=h;b.textBaseline="middle";b.beginPath();b.fillText(this.valueText,this.reflect1_(25*c/30),d);goog.isDefAndNotNull(this.targetValue)&&(this.reflect1_(0),c=70-2*this.targetValue,c+=2*this.value,c=Math.min(162,Math.max(16,c)),b.translate(0,c),this.bug.drawFunc(a),b.translate(0,-c))};goog.exportSymbol("Mavelous.Tape.prototype.drawFunc",Mavelous.Tape.prototype.drawFunc);Mavelous.Tape.SideType={LEFT:"left",RIGHT:"right"};Mavelous.PFD=function(a){this.init(a)};
Mavelous.PFD.prototype.init=function(a,b){var c=b||{};this.options=c;this.options.fontFamily=c.fontFamily||"Tahoma,monospace,sans-serif";this.options.fontSize=c.fontSize||8;this.options.fontColor=c.fontColor||"white";this.options.backgroundColor1=c.backgroundColor1||"black";this.options.backgroundColor2=c.backgroundColor2||"rgb(60,60,60)";this.options.bugColor=c.bugColor||"rgb(255,0,100)";this.options.highlightColor=c.highlightColor||"rgb(255,255,255)";this.options.skyColor=c.skyColor||"rgb(114,149,179)";
this.options.groundColor=c.groundColor||"rgb(165,105,63)";this.flightMode=this.targetAltitude=this.altitude=this.targetSpeed=this.speed=null;this.visible=!0;c=goog.dom.getElement(a);this.stage=new Kinetic.Stage({container:c,width:c.offsetWidth,height:c.offsetHeight});this.layer=new Kinetic.Layer;this.stage.add(this.layer);this.stage.setScale(c.offsetWidth/200,c.offsetWidth/200);this.attitudeIndicator=new Mavelous.ArtificialHorizon({x:35,y:20,width:130,height:130,groundColor:this.options.groundColor,
skyColor:this.options.skyColor,lineColor:"white",planeColor:"black"});this.layer.add(this.attitudeIndicator);this.speedTape=new Mavelous.Tape({x:0,y:15,fill:this.options.backgroundColor2,fontColor:this.options.fontColor,fontFamily:this.options.fontFamily,fontSize:this.options.fontSize,instantaneousBackgroundColor:this.options.backgroundColor1,bugColor:this.options.bugColor,side:Mavelous.Tape.SideType.LEFT});this.layer.add(this.speedTape);this.altitudeTape=new Mavelous.Tape({x:170,y:15,fill:this.options.backgroundColor2,
fontColor:this.options.fontColor,fontFamily:this.options.fontFamily,fontSize:this.options.fontSize,instantaneousBackgroundColor:this.options.backgroundColor1,bugColor:this.options.bugColor,side:Mavelous.Tape.SideType.RIGHT});this.layer.add(this.altitudeTape);c=0.9*this.options.fontSize;this.targetAltitudeDisplay=new Kinetic.Text({x:170,y:5,width:30,align:"center",fontSize:c,fontFamily:this.options.fontFamily,textFill:this.options.bugColor});this.layer.add(this.targetAltitudeDisplay);this.targetSpeedDisplay=
new Kinetic.Text({x:0,y:5,width:30,align:"center",fontSize:c,fontFamily:this.options.fontFamily,textFill:this.options.bugColor});this.layer.add(this.targetSpeedDisplay)};Mavelous.PFD.prototype.setSize=function(a,b){var c,d=0;a/b>4/3?(c=4/3*b,d=b):(c=a,d=0.75*a);this.stage.setSize(c,d);this.stage.setScale(c/200,c/200)};Mavelous.PFD.prototype.setSpeed=function(a){this.speedTape.setValue(a)};
Mavelous.PFD.prototype.setTargetSpeed=function(a){this.targetSpeed=a;null===a?(this.speedTape.setTargetValue(null),this.targetSpeedDisplay.hide()):(this.speedTape.setTargetValue(a),this.targetSpeedDisplay.setText(Math.round(a).toString()),this.targetSpeedDisplay.show())};Mavelous.PFD.prototype.draw=function(){this.visible&&this.layer.draw()};Mavelous.PFD.prototype.setVisible=function(a){this.visible=a};Mavelous.PFD.prototype.setAltitude=function(a){this.altitudeTape.setValue(a)};
Mavelous.PFD.prototype.setTargetAltitude=function(a){this.targetAltitude=a;null===a?(this.altitudeTape.setTargetValue(null),this.targetAltitudeDisplay.hide()):(this.altitudeTape.setTargetValue(a),this.targetAltitudeDisplay.setText(Math.round(a).toString()),this.targetAltitudeDisplay.show())};Mavelous.PFD.setHeading=function(a){};Mavelous.PFD.prototype.setAttitude=function(a,b){this.attitudeIndicator.setPitchRoll(a,b)};goog.json={};goog.json.isValid_=function(a){return/^\s*$/.test(a)?!1:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,""))};goog.json.parse=function(a){a=String(a);if(goog.json.isValid_(a))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);};goog.json.unsafeParse=function(a){return eval("("+a+")")};
...
goog.json.Serializer.prototype.serializeObject_=function(a,b){b.push("{");var c="",d;for(d in a)if(Object.prototype.hasOwnProperty.call(a,d)){var e=a[d];"function"!=typeof e&&(b.push(c),this.serializeString_(d,b),b.push(":"),this.serialize_(this.replacer_?this.replacer_.call(a,d,e):e,b),c=",")}b.push("}")};Mavelous.PFDSettingsModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.PFDSettingsModel,Backbone.Model);Mavelous.PFDSettingsModel.Position={TOPLEFT:0,TOPRIGHT:1,BOTTOMLEFT:2,BOTTOMRIGHT:3};Mavelous.PFDSettingsModel.Size={STANDARD:0,FULLSCREEN:1,SMALL:2,HIDDEN:3};Mavelous.PFDSettingsModel.prototype.initialize=function(){this.bind("change",function(){this.writeToCookie()})};goog.exportSymbol("Mavelous.PFDSettingsModel.prototype.initialize",Mavelous.PFDSettingsModel.prototype.initialize);
Mavelous.PFDSettingsModel.prototype.defaults=function(){var a=this.readFromCookie();return a?{position:a.position||Mavelous.PFDSettingsModel.Position.TOPLEFT,size:a.size||Mavelous.PFDSettingsModel.Size.STANDARD}:{position:Mavelous.PFDSettingsModel.Position.TOPLEFT,size:Mavelous.PFDSettingsModel.Size.STANDARD}};goog.exportSymbol("Mavelous.PFDSettingsModel.prototype.defaults",Mavelous.PFDSettingsModel.prototype.defaults);
Mavelous.PFDSettingsModel.prototype.readFromCookie=function(){var a=$.cookie("pfdSettings");if(a){window.console.log("cookieData");window.console.log(a);try{return goog.json.parse(a)}catch(b){return window.console.warn("Unable to parse pfdSettings cookie data:"),window.console.warn(a),null}}else return null};Mavelous.PFDSettingsModel.prototype.writeToCookie=function(){var a=goog.json.serialize(this.toJSON());window.console.log("writeToCookie:");window.console.log(a);$.cookie("pfdSettings",a)};Mavelous.PFDView=function(a){this.pfd=null;this.settingToDimension={};Backbone.View.call(this,a)};goog.inherits(Mavelous.PFDView,Backbone.View);
Mavelous.PFDView.prototype.initialize=function(){this.blockel=this.options.blockel;this.statel=this.options.statel;this.pfdel=$("#"+this.options.drawingid);var a=this.options.mavlinkSrc;this.attitude=a.subscribe("ATTITUDE",this.onAttitudeChange,this);this.vfrHud=a.subscribe("VFR_HUD",this.onVfrHudChange,this);this.navControllerOutput=a.subscribe("NAV_CONTROLLER_OUTPUT",this.onNavControllerOutputChange,this);this.pfd=new Mavelous.PFD(this.options.drawingid);this.options.settingsModel&&(this.settingsModel=
this.options.settingsModel,this.settingToDimension[Mavelous.PFDSettingsModel.Size.STANDARD]={height:function(){return"280px"},width:function(){return"400px"}},this.settingToDimension[Mavelous.PFDSettingsModel.Size.FULLSCREEN]={height:function(){return $(window).height()-120},width:function(){return $(window).width()}},this.settingToDimension[Mavelous.PFDSettingsModel.Size.SMALL]={height:function(){return"140px"},width:function(){return"200px"}},this.settingsModel.bind("change",this.onSettingsChange,
this),this.onSettingsChange());this.onAttitudeChange();this.onVfrHudChange();this.onNavControllerOutputChange()};goog.exportSymbol("Mavelous.PFDView.prototype.initialize",Mavelous.PFDView.prototype.initialize);Mavelous.PFDView.prototype.onAttitudeChange=function(){this.pfd.setAttitude(this.attitude.get("pitch"),this.attitude.get("roll"));this.pfd.draw()};
Mavelous.PFDView.prototype.onVfrHudChange=function(){var a=this.vfrHud.get("alt");this.pfd.setAltitude(a);a=this.vfrHud.get("airspeed");this.pfd.setSpeed(a);this.pfd.draw()};Mavelous.PFDView.prototype.onNavControllerOutputChange=function(){var a=this.navControllerOutput.get("alt_error"),b=this.navControllerOutput.get("aspd_error");0<Math.abs(a)&&this.pfd.setTargetAltitude(this.vfrHud.get("alt")+a);0<Math.abs(b)&&this.pfd.setTargetSpeed(this.vfrHud.get("airspeed")+b)};
Mavelous.PFDView.prototype.onSettingsChange=function(){var a=this.settingsModel.toJSON();this.setPosition(a.position);this.setSize(a.size)};
Mavelous.PFDView.prototype.setPosition=function(a){this.blockel.removeClass("pfd-top pfd-bottom pfd-left pfd-right");switch(a){case Mavelous.PFDSettingsModel.Position.TOPLEFT:this.blockel.addClass("pfd-top pfd-left");break;case Mavelous.PFDSettingsModel.Position.TOPRIGHT:this.blockel.addClass("pfd-top pfd-right");break;case Mavelous.PFDSettingsModel.Position.BOTTOMLEFT:this.blockel.addClass("pfd-bottom pfd-left");break;case Mavelous.PFDSettingsModel.Position.BOTTOMRIGHT:this.blockel.addClass("pfd-bottom pfd-right")}};
Mavelous.PFDView.prototype.setSize=function(a){goog.asserts.assert(goog.object.containsValue(Mavelous.PFDSettingsModel.Size,a),"unknown PFD size value: "+a);var b=this.blockel;a==Mavelous.PFDSettingsModel.Size.FULLSCREEN?$("#droneicon").addClass("droneicon-hide"):$("#droneicon").hasClass("droneicon-hide")&&$("#droneicon").removeClass("droneicon-hide");a==Mavelous.PFDSettingsModel.Size.HIDDEN?(this.pfd.setVisible(!1),b.hide()):(b.is(":hidden")&&(this.pfd.setVisible(!0),b.show()),b=this.settingToDimension[a],
a=b.width(),b=b.height(),this.pfdel.width(a).height(b),this.blockel.width(a),this.statel.width(a),this.pfd.setSize(this.pfdel.width(),this.pfdel.height()))};Mavelous.GuideAltitudeView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.GuideAltitudeView,Backbone.View);Mavelous.GuideAltitudeView.prototype.initialize=function(){var a=this;this.input=this.options.input;this.submit=this.options.submit;this.text=this.options.text;this.model.bind("change",this.render,this);this.render();this.input.change(function(){a.model.set({alt:a.input.val()})});this.submit.click(function(){a.model.send()})};
goog.exportSymbol("Mavelous.GuideAltitudeView.prototype.initialize",Mavelous.GuideAltitudeView.prototype.initialize);Mavelous.GuideAltitudeView.prototype.render=function(){var a=this.model.toJSON();this.text.html(a.alt.toString()+" m");this.input.val(a.alt);return this};goog.exportSymbol("Mavelous.GuideAltitudeView.prototype.render",Mavelous.GuideAltitudeView.prototype.render);Mavelous.FakeVehicle=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.FakeVehicle,Backbone.Model);Mavelous.FakeVehicle.prototype.defaults=function(){return{lat:37.7751,lon:-122.419,alt:30,heading:90,pitch:0,roll:0,velocity:10,t:0}};Mavelous.FakeVehicle.prototype.initialize=function(){var a=Date.now();this.lastmessagetime=this.lastupdate=this.firstupdate=a};goog.exportSymbol("Mavelous.FakeVehicle.prototype.initialize",Mavelous.FakeVehicle.prototype.initialize);
Mavelous.FakeVehicle.prototype.update=function(){var a=Date.now(),b=(a-this.lastupdate)/1E3,c=(a-this.firstupdate)/1E3,d=Mavelous.FakeVehicle.nextposition(this,b),e=this.toJSON(),f=2*b*e.velocity*Math.sin(goog.math.toRadians(e.pitch)),b=4*b*e.velocity*Math.sin(goog.math.toRadians(e.roll));this.set({lat:d.lat,lon:d.lon,alt:e.alt+f,heading:e.heading+b,pitch:8*Math.sin(c),roll:5+15*Math.sin(c/2),t:c});this.lastupdate=a};
Mavelous.FakeVehicle.prototype.requestMessages=function(a){var b=Date.now(),c=200<b-this.lastmessagetime;c&&(this.lastmessagetime=b);var d=this.toJSON(),e={};_.each(a,function(a,b){if(b in Mavelous.FakeVehicle.fakeHandlers){var h=a.get("_index")||0;e[b]={index:c?h+1:h,msg:Mavelous.FakeVehicle.fakeHandlers[b](d)}}});return e};Mavelous.FakeVehicle.fakeAttitude=function(a){return{pitch:goog.math.toRadians(a.pitch),roll:goog.math.toRadians(a.roll)}};
Mavelous.FakeVehicle.fakeVfrHud=function(a){return{heading:a.heading,alt:a.alt,airspeed:a.velocity}};Mavelous.FakeVehicle.fakeNavControllerOutput=function(a){return{alt_error:30-a.alt,aspd_error:4-a.velocity}};Mavelous.FakeVehicle.fakeGpsRawInt=function(a){return{fix_type:3,lat:Math.round(1E7*a.lat),lon:Math.round(1E7*a.lon)}};Mavelous.FakeVehicle.fakeMetaWaypoint=function(a){return{}};Mavelous.FakeVehicle.fakeHeartbeat=function(a){return{type:2,base_mode:129,custom_mode:3}};
Mavelous.FakeVehicle.fakeMetaLinkquality=function(a){return{master_in:Math.floor(11*a.t),master_out:Math.floor(9*a.t),mav_loss:0}};Mavelous.FakeVehicle.fakeGpsStatus=function(a){return{satellites_visible:8}};Mavelous.FakeVehicle.fakeStatustext=function(a){return{text:"Offline mode"}};Mavelous.FakeVehicle.fakeSysStatus=function(a){return{}};
Mavelous.FakeVehicle.fakeHandlers={ATTITUDE:Mavelous.FakeVehicle.fakeAttitude,VFR_HUD:Mavelous.FakeVehicle.fakeVfrHud,NAV_CONTROLLER_OUTPUT:Mavelous.FakeVehicle.fakeNavControllerOutput,GPS_RAW_INT:Mavelous.FakeVehicle.fakeGpsRawInt,META_WAYPOINT:Mavelous.FakeVehicle.fakeMetaWaypoint,HEARTBEAT:Mavelous.FakeVehicle.fakeHeartbeat,META_LINKQUALITY:Mavelous.FakeVehicle.fakeMetaLinkquality,GPS_STATUS:Mavelous.FakeVehicle.fakeGpsStatus,STATUSTEXT:Mavelous.FakeVehicle.fakeStatustext,SYS_STATUS:Mavelous.FakeVehicle.fakeSysStatus};
Mavelous.FakeVehicle.nextposition=function(a,b){var c=goog.math.toRadians(a.get("lat")),d=goog.math.toRadians(a.get("lon")),e=goog.math.toRadians(a.get("heading")),f=a.get("velocity")*b/1E3,g=Math.asin(Math.sin(c)*Math.cos(f/6371)+Math.cos(c)*Math.sin(f/6371)*Math.cos(e)),e=Math.sin(e)*Math.sin(f/6371)*Math.cos(c),c=Math.cos(f/6371)-Math.sin(c)*Math.sin(g),d=d+Math.atan2(e,c),d=(d+Math.PI)%(2*Math.PI)-Math.PI;if(isNaN(g)||isNaN(d))throw Error("nope");return{lat:goog.math.toDegrees(g),lon:goog.math.toDegrees(d)}};goog.structs={};goog.structs.Collection=function(){};goog.structs.getCount=function(a){return"function"==typeof a.getCount?a.getCount():goog.isArrayLike(a)||goog.isString(a)?a.length:goog.object.getCount(a)};goog.structs.getValues=function(a){if("function"==typeof a.getValues)return a.getValues();if(goog.isString(a))return a.split("");if(goog.isArrayLike(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return goog.object.getValues(a)};
...
goog.debug.enhanceError=function(a,b){var c="string"==typeof a?Error(a):a;c.stack||(c.stack=goog.debug.getStacktrace(arguments.callee.caller));if(b){for(var d=0;c["message"+d];)++d;c["message"+d]=String(b)}return c};
...
goog.debug.LogManager.createLogger_=function(a){var b=new goog.debug.Logger(a);if(goog.debug.Logger.ENABLE_HIERARCHY){var c=a.lastIndexOf("."),d=a.substr(0,c),c=a.substr(c+1),d=goog.debug.LogManager.getLogger(d);d.addChild_(c,b);b.setParent_(d)}return goog.debug.LogManager.loggers_[a]=b};Mavelous.MavlinkMessage=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.MavlinkMessage,Backbone.Model);Mavelous.MavlinkAPI=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.MavlinkAPI,Backbone.Model);Mavelous.MavlinkAPI.prototype.initialize=function(){this.logger_=goog.debug.Logger.getLogger("mavelous.MavlinkAPI");this.url=this.get("url");this.gotonline=!1;this.online=!0;this.failcount=0;this.messageModels={};this.fakevehicle=null};
goog.exportSymbol("Mavelous.MavlinkAPI.prototype.initialize",Mavelous.MavlinkAPI.prototype.initialize);Mavelous.MavlinkAPI.prototype.subscribe=function(a,b,c){this.messageModels[a]||(this.messageModels[a]=new Mavelous.MavlinkMessage({_type:a,_index:-1}));a=this.messageModels[a];a.bind("change",b,c);return a};Mavelous.MavlinkAPI.prototype.handleMessages_=function(a){this.trigger("gotServerResponse");_.each(a,this.handleMessage_,this)};
Mavelous.MavlinkAPI.prototype.handleMessage_=function(a,b){var c=this.messageModels[b],d=c.get("_index");if(void 0===d||a.index>d)c.set({_index:a.index},{silent:!0}),c.set(a.msg)};Mavelous.MavlinkAPI.prototype.update=function(){if(this.online)this.onlineUpdate();else this.offlineUpdate()};
Mavelous.MavlinkAPI.prototype.onlineUpdate=function(){$.ajax({context:this,type:"GET",cache:!1,url:this.url+_.keys(this.messageModels).join("+"),datatype:"json",success:function(a){this.gotonline=!0;this.handleMessages_(a)},error:function(){this.trigger("gotServerError");this.gotonline||(this.failcount++,5<this.failcount&&this.useOfflineMode())}})};
Mavelous.MavlinkAPI.prototype.offlineUpdate=function(){goog.asserts.assert(this.fakevehicle);this.fakevehicle.update();var a=this.fakevehicle.requestMessages(this.messageModels);this.handleMessages_(a)};Mavelous.MavlinkAPI.prototype.useOfflineMode=function(){this.online&&!this.gotonline&&(this.logger_.info("Switching to offline mode"),this.online=!1,this.fakevehicle=new Mavelous.FakeVehicle({lat:45.5233,lon:-122.667}))};Mavelous.FlightModeModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.FlightModeModel,Backbone.Model);Mavelous.FlightModeModel.prototype.defaults=function(){return{armed:!1,arming:!1,disarming:!1,modestring:"None"}};goog.exportSymbol("Mavelous.FlightModeModel.prototype.defaults",Mavelous.FlightModeModel.prototype.defaults);
Mavelous.FlightModeModel.prototype.initialize=function(){this.heartbeat=this.get("mavlinkSrc").subscribe("HEARTBEAT",this.onHeartbeat,this);this.on("change:armed",this.onChangeArmed,this)};goog.exportSymbol("Mavelous.FlightModeModel.prototype.initialize",Mavelous.FlightModeModel.prototype.initialize);Mavelous.FlightModeModel.prototype.onHeartbeat=function(){var a=Mavelous.util.heartbeat.modestring(this.heartbeat),b=Mavelous.util.heartbeat.armed(this.heartbeat);this.set({armed:b,modestring:a})};
Mavelous.FlightModeModel.prototype.onChangeArmed=function(){this.get("armed")?this.get("arming")&&this.set("arming",!1):this.get("disarming")&&this.set("disarming",!1)};Mavelous.FlightModeModel.prototype.requestArm=function(){this.postArmRequest_(!0);this.set("arming",!0)};Mavelous.FlightModeModel.prototype.requestDisarm=function(){this.postArmRequest_(!1);this.set("disarming",!0)};
Mavelous.FlightModeModel.prototype.postArmRequest_=function(a){$.ajax({type:"POST",url:"/command_long",data:goog.json.serialize({command:"COMPONENT_ARM_DISARM",component:"SYSTEM_CONTROL",setting:a?"ARM":"DISARM"})})};Mavelous.CommandLongModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.CommandLongModel,Backbone.Model);
Mavelous.CommandLongModel.prototype.post=function(a){"string"==typeof a?$.ajax({type:"POST",url:"/command_long",data:goog.json.serialize({command:a})}):$.ajax({type:"POST",url:"/command_long",data:goog.json.serialize(a)})};Mavelous.ArmingButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.ArmingButtonView,Backbone.View);
Mavelous.ArmingButtonView.prototype.initialize=function(){this.model.on("change:armed change:arming change:disarming",this.onChange_,this);this.$el.click(goog.bind(this.onClick_,this));this.onChange_()};goog.exportSymbol("Mavelous.ArmingButtonView.prototype.initialize",Mavelous.ArmingButtonView.prototype.initialize);Mavelous.ArmingButtonView.prototype.onClick_=function(){this.model.get("armed")?this.model.requestDisarm():this.model.requestArm()};
Mavelous.ArmingButtonView.prototype.onChange_=function(){this.$el.removeClass("btn-success btn-warning");this.model.get("armed")?(this.model.get("disarming")?this.$el.html("Disarming..."):this.$el.html("Click to Disarm"),this.$el.addClass("btn-warning")):(this.model.get("arming")?this.$el.html("Arming..."):this.$el.html("Click to Arm"),this.$el.addClass("btn-success"))};Mavelous.CommandButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.CommandButtonView,Backbone.View);
Mavelous.CommandButtonView.prototype.initialize=function(){this.command=this.options.command;this.$el.click(goog.bind(this.onClick_,this))};goog.exportSymbol("Mavelous.CommandButtonView.prototype.initialize",Mavelous.CommandButtonView.prototype.initialize);Mavelous.CommandButtonView.prototype.onClick_=function(){this.model.post(this.command)};Mavelous.FlightModeButtonView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.FlightModeButtonView,Backbone.View);
Mavelous.FlightModeButtonView.prototype.initialize=function(){this.modeModel=this.options.modeModel;this.$el=this.options.el;this.modeModel.on("change",this.onChange_,this)};goog.exportSymbol("Mavelous.FlightModeButtonView.prototype.initialize",Mavelous.FlightModeButtonView.prototype.initialize);Mavelous.FlightModeButtonView.prototype.onChange_=function(){this.$el.removeClass("btn-success btn-warning");this.modeModel.get("armed")?this.$el.addClass("btn-success"):this.$el.addClass("btn-warning");this.$el.html(this.modeModel.get("modestring"))};Mavelous.SettingsView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.SettingsView,Backbone.View);
Mavelous.SettingsView.prototype.initialize=function(){var a=this;this.modalToggle=this.options.modalToggle;this.modal=this.options.modal;this.modalToggle.click(function(){a.modal.modal("toggle")});this.map=this.options.map;this.mapView=this.options.mapView;this.mapProviderModel=this.options.mapProviderModel;this.vehicleIconModel=this.options.vehicleIconModel;this.mapProviderPicker=this.options.mapProviderPicker;this.mapZoomSlider=this.options.mapZoomSlider;this.mapZoomValue=this.options.mapZoomValue;
this.mapPathPicker=this.options.mapPathPicker;this.vehicleIconPicker=this.options.vehicleIconPicker;this.setupMapProviderPicker();this.setupMapZoomSlider();this.setupMapPathPicker();this.setupVehicleIconPicker();this.pfdSettingsModel=this.options.pfdSettingsModel;this.pfdPositionLeft=this.options.pfdPositionLeft;this.pfdPositionRight=this.options.pfdPositionRight;this.pfdPositionUp=this.options.pfdPositionUp;this.pfdPositionDown=this.options.pfdPositionDown;this.setupPFDSettings()};
goog.exportSymbol("Mavelous.SettingsView.prototype.initialize",Mavelous.SettingsView.prototype.initialize);Mavelous.SettingsView.prototype.setupMapProviderPicker=function(){var a=this;void 0!==this.mapProviderModel&&(_.each(Mavelous.LeafletProviders.Providers,function(b,c){a.mapProviderPicker.append('<option value="'+c+'">'+b.description+"</option>")}),this.mapProviderPicker.change(function(){var b=a.mapProviderPicker.val();a.mapProviderModel.set("provider",b)}))};
Mavelous.SettingsView.prototype.setupMapZoomSlider=function(){var a=this;void 0!==this.map&&(this.mapZoomSlider.change(function(){a.map.setZoom(a.mapZoomSlider.val())}),this.map.on("zoomend",this.onZoomChange,this))};Mavelous.SettingsView.prototype.setupMapPathPicker=function(){var a=this;void 0!==this.map&&this.mapPathPicker.change(function(){var b=a.mapPathPicker.val();a.mapView.setPathVisible(b)})};
Mavelous.SettingsView.prototype.setupVehicleIconPicker=function(){var a=this;void 0!==this.vehicleIconModel&&(_.each(Mavelous.LeafletDroneIconModel.Icons,function(b,c){a.vehicleIconPicker.append('<option value="'+c+'">'+b.description+"</option>")}),this.vehicleIconPicker.change(function(){var b=a.vehicleIconPicker.val();a.vehicleIconModel.set("icon",b)}))};Mavelous.SettingsView.prototype.onZoomChange=function(){this.mapZoomSlider.val(this.map.getZoom());this.mapZoomValue.html(this.map.getZoom().toString())};
Mavelous.SettingsView.prototype.setupPFDSettings=function(){var a=this;this.pfdPositionLeft.click(function(){a.pfdPositionUp.hasClass("active")?a.pfdSettingsModel.set("position",Mavelous.PFDSettingsModel.Position.TOPLEFT):a.pfdSettingsModel.set("position",Mavelous.PFDSettingsModel.Position.BOTTOMLEFT)});this.pfdPositionRight.click(function(){a.pfdPositionUp.hasClass("active")?a.pfdSettingsModel.set("position",Mavelous.PFDSettingsModel.Position.TOPRIGHT):a.pfdSettingsModel.set("position",Mavelous.PFDSettingsModel.Position.BOTTOMRIGHT)});
this.pfdPositionUp.click(function(){a.pfdPositionLeft.hasClass("active")?a.pfdSettingsModel.set("position",Mavelous.PFDSettingsModel.Position.TOPLEFT):a.pfdSettingsModel.set("position",Mavelous.PFDSettingsModel.Position.TOPRIGHT)});this.pfdPositionDown.click(function(){a.pfdPositionLeft.hasClass("active")?a.pfdSettingsModel.set("position",Mavelous.PFDSettingsModel.Position.BOTTOMLEFT):a.pfdSettingsModel.set("position",Mavelous.PFDSettingsModel.Position.BOTTOMRIGHT)});this.pfdSettingsModel.bind("change",
this.onPFDSettingsChange,this);this.onPFDSettingsChange()};
Mavelous.SettingsView.prototype.onPFDSettingsChange=function(){switch(this.pfdSettingsModel.get("position")){case Mavelous.PFDSettingsModel.Position.TOPLEFT:this.pfdPositionLeft.button("toggle");this.pfdPositionUp.button("toggle");break;case Mavelous.PFDSettingsModel.Position.TOPRIGHT:this.pfdPositionRight.button("toggle");this.pfdPositionUp.button("toggle");break;case Mavelous.PFDSettingsModel.Position.BOTTOMLEFT:this.pfdPositionLeft.button("toggle");this.pfdPositionDown.button("toggle");break;case Mavelous.PFDSettingsModel.Position.BOTTOMRIGHT:this.pfdPositionRight.button("toggle"),
this.pfdPositionDown.button("toggle")}};var markerIcon=L.Icon.extend({options:{iconUrl:"third_party/leaflet/images/marker-icon.png",shadowUrl:"third_party/leaflet/images/marker-shadow.png",iconAnchor:new L.Point(13,41),iconSize:new L.Point(25,41)}});L.Transition=null;Mavelous.UnanimatedMap=function(a,b){L.Map.call(this,a,b)};goog.inherits(Mavelous.UnanimatedMap,L.Map);
Mavelous.UnanimatedMap.prototype.panTo=function(a){a=this._getNewTopLeftPoint(a).subtract(this._getTopLeftPoint());this.fire("movestart");this._rawPanBy(a);this.fire("move");this.fire("moveend")};Mavelous.LeafletView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.LeafletView,Backbone.View);
Mavelous.LeafletView.prototype.initialize=function(){this.vehicleModel=this.options.vehicle;this.vehicleIconModel=this.options.vehicleIcon;this.providerModel=this.options.provider;this.guideModel=this.options.guideModel;this.panModel=this.options.panModel;this.initializedcenter=!1;this.vehiclePathVisible=!0;this.tileLayer=this.providerModel.getProvider();this.touchzoomable=L.Browser.touch&&!L.Browser.android23;this.map=new Mavelous.UnanimatedMap("map",{layers:[this.tileLayer],zoomControl:!1,doubleClickZoom:!1,
attributionControl:!1,maxZoom:21,scrollWheelZoom:!1,centerScrollWheelZoom:!0,touchZoom:!1,centerTouchZoom:this.touchzoomable});this.providerModel.bind("change",this.providerChange,this);this.vehicleIconModel.bind("change",this.vehicleIconChange,this);this.panModel.bind("change:center",this.panModelChange,this);this.panModel.bind("change:tracking",this.panTrackingChange,this);this.map.addEventListener("dragstart",function(){this.panModel.cancelTracking()},this);this.vehicleModel.bind("change",this.updateVehicleMarker,
this);this.vehicleModel.bind("change",this.updateVehiclePath,this);this.map.addEventListener("dblclick",this.doubleClickHandler,this);this.guideModel.bind("change",this.updateGuideMarker,this)};goog.exportSymbol("Mavelous.LeafletView.prototype.initialize",Mavelous.LeafletView.prototype.initialize);Mavelous.LeafletView.prototype.doubleClickHandler=function(a){this.guideModel.setTarget({lat:a.latlng.lat,lon:a.latlng.lng})};
Mavelous.LeafletView.prototype.providerChange=function(){this.map.removeLayer(this.tileLayer);this.tileLayer=this.providerModel.getProvider();this.map.addLayer(this.tileLayer)};Mavelous.LeafletView.prototype.panModelChange=function(){var a=this.panModel.get("center");void 0!==a&&(this.initializedcenter?this.map.panTo(a):(this.map.setView(a,16),this.initializedcenter=!0))};
Mavelous.LeafletView.prototype.panTrackingChange=function(){var a=this.panModel.get("tracking");void 0!==a&&(a?(this.map.scrollWheelZoom.disable(),this.map.centerScrollWheelZoom.enable(),this.map.touchZoom.disable(),this.touchzoomable&&this.map.centerTouchZoom.enable()):(this.map.scrollWheelZoom.enable(),this.map.centerScrollWheelZoom.disable(),this.map.centerTouchZoom.disable(),this.touchzoomable&&this.map.touchZoom.enable()))};
Mavelous.LeafletView.prototype.updateVehicleMarker=function(){if(this.initializedcenter){var a=this.vehicleModel.get("position"),b=this.vehicleModel.get("heading");a&&b&&(void 0===this.vehicleMarker?(this.vehicleMarker=new L.Marker(a,{icon:this.vehicleIconModel.getIcon(),iconAngle:b}),this.map.addLayer(this.vehicleMarker)):(this.vehicleMarker.setLatLng(a),this.vehicleMarker.setIconAngle(b)))}};
Mavelous.LeafletView.prototype.vehicleIconChange=function(){var a=this.vehicleModel.get("position"),b=this.vehicleModel.get("heading");a&&b&&(this.map.removeLayer(this.vehicleMarker),this.vehicleMarker=new L.Marker(a,{icon:this.vehicleIconModel.getIcon(),iconAngle:b}),this.map.addLayer(this.vehicleMarker))};
Mavelous.LeafletView.prototype.setPathVisible=function(a){void 0===this.vehiclePathVisible&&(this.vehiclePathVisible=!0);"on"==a&&(this.vehiclePathVisible=!0);"off"==a&&(this.vehiclePathVisible=!1,this.map.removeLayer(this.vehiclePath),this.vehiclePath=void 0)};
Mavelous.LeafletView.prototype.updateVehiclePath=function(){var a=this.vehicleModel.get("position");a&&!1!=this.vehiclePathVisible&&(void 0===this.vehiclePath?(this.vehiclePath=new L.Polyline([a],{color:"red"}),this.vehiclePath.addTo(this.map)):this.vehiclePath.addLatLng(a))};
Mavelous.LeafletView.prototype.updateGuideMarker=function(){var a=this.guideModel.toJSON(),b=new L.LatLng(a.lat,a.lon);a&&(void 0===this.guideMarker?(this.guideMarker=new L.Marker(b,{icon:new markerIcon}),this.map.addLayer(this.guideMarker)):this.guideMarker.setLatLng(b))};Mavelous.VehicleLeafletPosition=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.VehicleLeafletPosition,Backbone.Model);Mavelous.VehicleLeafletPosition.prototype.defaults=function(){return{position:null,heading:0}};goog.exportSymbol("Mavelous.VehicleLeafletPosition.prototype.defaults",Mavelous.VehicleLeafletPosition.prototype.defaults);
Mavelous.VehicleLeafletPosition.prototype.initialize=function(){var a=this.get("mavlinkSrc");this.vehicleGps=a.subscribe("GPS_RAW_INT",this.withVehicleGps,this);this.vehicleHead=a.subscribe("VFR_HUD",this.withVehicleHead,this)};goog.exportSymbol("Mavelous.VehicleLeafletPosition.prototype.initialize",Mavelous.VehicleLeafletPosition.prototype.initialize);
Mavelous.VehicleLeafletPosition.prototype.withVehicleGps=function(){var a=this.vehicleGps.toJSON();0===a.lat&&0===a.lon||this.set("position",new L.LatLng(a.lat/1E7,a.lon/1E7))};Mavelous.VehicleLeafletPosition.prototype.withVehicleHead=function(){var a=this.vehicleHead.get("heading");this.set("heading",a)};Mavelous.GuideModel=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.GuideModel,Backbone.Model);Mavelous.GuideModel.prototype.defaults=function(){return{alt:20,lat:null,lon:null}};goog.exportSymbol("Mavelous.GuideModel.prototype.defaults",Mavelous.GuideModel.prototype.defaults);Mavelous.GuideModel.prototype.initialize=function(){this.metaWaypointModel=this.get("mavlinkSrc").subscribe("META_WAYPOINT",this.onMetaWaypointChange,this)};
goog.exportSymbol("Mavelous.GuideModel.prototype.initialize",Mavelous.GuideModel.prototype.initialize);Mavelous.GuideModel.prototype.onMetaWaypointChange=function(){var a=this.metaWaypointModel.get("waypoint");a&&this.set({alt:a.alt,lat:a.lat,lon:a.lon})};Mavelous.GuideModel.prototype.setTarget=function(a){this.set(a);this.send()};Mavelous.GuideModel.prototype.send=function(){var a={lat:this.get("lat"),lon:this.get("lon"),alt:this.get("alt")};null!==a.lat&&null!==a.lon&&null!==a.alt&&this.sendServer(a)};
Mavelous.GuideModel.prototype.sendServer=function(a){a=goog.json.serialize({command:"FLYTO",location:a});$.ajax({type:"POST",url:"/guide",data:a})};Mavelous.LeafletProviders=function(a){Backbone.Model.call(this,a)};goog.inherits(Mavelous.LeafletProviders,Backbone.Model);Mavelous.LeafletProviders.bingKey="AnFxXUB376BgaEQMj947c43V45ipmMvdcoY-TAE4-Y23mu1yFLHF0k2BMJP-MU1B";Mavelous.LeafletProviders.prototype.defaults=function(){return{provider:"bing"}};goog.exportSymbol("Mavelous.LeafletProviders.prototype.defaults",Mavelous.LeafletProviders.prototype.defaults);
Mavelous.LeafletProviders.prototype.getProvider=function(){var a=this.get("provider");return Mavelous.LeafletProviders.Providers[a].constructor()};
Mavelous.LeafletProviders.Providers={bing:{description:"Bing Satellite with Labels",constructor:function(){return new L.BingLayer(Mavelous.LeafletProviders.bingKey,{type:"AerialWithLabels",maxZoom:21})}},cloudmade:{description:"Cloudmade Road Map",constructor:function(){return new L.TileLayer("http://{s}.tile.cloudmade.com/420c27bae8514670a02a1684e8398d33/997/256/{z}/{x}/{y}.png",{maxZoom:18})}},osm:{description:"OpenStreetMaps",constructor:function(){return new L.TileLayer("http://{s}.tile.openstreetmap.org//{z}/{x}/{y}.png",
{maxZoom:18})}}};goog.math.Box=function(a,b,c,d){this.top=a;this.right=b;this.bottom=c;this.left=d};goog.math.Box.boundingBox=function(a){for(var b=new goog.math.Box(arguments[0].y,arguments[0].x,arguments[0].y,arguments[0].x),c=1;c<arguments.length;c++){var d=arguments[c];b.top=Math.min(b.top,d.y);b.right=Math.max(b.right,d.x);b.bottom=Math.max(b.bottom,d.y);b.left=Math.min(b.left,d.x)}return b};goog.math.Box.prototype.clone=function(){return new goog.math.Box(this.top,this.right,this.bottom,this.left)};
...
goog.ui.Component.prototype.removeChildren=function(a){for(var b=[];this.hasChildren();)b.push(this.removeChildAt(0,a));return b};goog.async.Delay=function(a,b,c){goog.Disposable.call(this);this.listener_=a;this.interval_=b||0;this.handler_=c;this.callback_=goog.bind(this.doAction_,this)};goog.inherits(goog.async.Delay,goog.Disposable);goog.Delay=goog.async.Delay;goog.async.Delay.prototype.id_=0;goog.async.Delay.prototype.disposeInternal=function(){goog.async.Delay.superClass_.disposeInternal.call(this);this.stop();delete this.listener_;delete this.handler_};
...
goog.async.AnimationDelay.prototype.getRaf_=function(){var a=this.win_;return a.requestAnimationFrame||a.webkitRequestAnimationFrame||a.mozRequestAnimationFrame||a.oRequestAnimationFrame||a.msRequestAnimationFrame||null};goog.async.AnimationDelay.prototype.getCancelRaf_=function(){var a=this.win_;return a.cancelRequestAnimationFrame||a.webkitCancelRequestAnimationFrame||a.mozCancelRequestAnimationFrame||a.oCancelRequestAnimationFrame||a.msCancelRequestAnimationFrame||null};goog.debug.FpsDisplay=function(a){goog.ui.Component.call(this,a)};goog.inherits(goog.debug.FpsDisplay,goog.ui.Component);goog.debug.FpsDisplay.CSS="goog-fps-display";goog.debug.FpsDisplay.SAMPLES=10;goog.debug.FpsDisplay.prototype.animation_=null;goog.debug.FpsDisplay.prototype.createDom=function(){this.setElementInternal(this.getDomHelper().createDom("div",goog.debug.FpsDisplay.CSS))};
goog.debug.FpsDisplay.prototype.enterDocument=function(){goog.debug.FpsDisplay.superClass_.enterDocument.call(this);this.animation_=new goog.debug.FpsDisplay.FpsAnimation_(this.getElement());this.delay_=new goog.async.AnimationDelay(this.handleDelay_,this.getDomHelper().getWindow(),this);this.delay_.start()};goog.debug.FpsDisplay.prototype.handleDelay_=function(a){this.isInDocument()&&(this.animation_.onAnimationFrame(a),this.delay_.start())};
goog.debug.FpsDisplay.prototype.exitDocument=function(){goog.debug.FpsDisplay.superClass_.exitDocument.call(this);this.animation_=null;goog.dispose(this.delay_)};goog.debug.FpsDisplay.prototype.getFps=function(){goog.asserts.assert(this.isInDocument(),"Render the FPS display before querying FPS");return this.animation_.lastFps_};goog.debug.FpsDisplay.FpsAnimation_=function(a){this.element_=a;this.frameNumber_=0};goog.debug.FpsDisplay.FpsAnimation_.prototype.lastTime_=0;
goog.debug.FpsDisplay.FpsAnimation_.prototype.lastFps_=-1;goog.debug.FpsDisplay.FpsAnimation_.prototype.onAnimationFrame=function(a){var b=goog.debug.FpsDisplay.SAMPLES;0==this.frameNumber_%b&&(this.lastFps_=Math.round(1E3*b/(a-this.lastTime_)),this.element_.innerHTML=this.lastFps_,this.lastTime_=a);this.frameNumber_++};goog.uri={};goog.uri.utils={};goog.uri.utils.CharCode_={AMPERSAND:38,EQUAL:61,HASH:35,QUESTION:63};goog.uri.utils.buildFromEncodedParts=function(a,b,c,d,e,f,g){var h="";a&&(h+=a+":");c&&(h+="//",b&&(h+=b+"@"),h+=c,d&&(h+=":"+d));e&&(h+=e);f&&(h+="?"+f);g&&(h+="#"+g);return h};goog.uri.utils.splitRe_=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$");
...
goog.Uri.QueryData.prototype.extend=function(a){for(var b=0;b<arguments.length;b++)goog.structs.forEach(arguments[b],function(a,b){this.add(b,a)},this)};Mavelous.CommStatusPopoverViewDelegate=function(a){this.popoverTitle="Link Info";this.$el=null;Backbone.View.call(this,a)};goog.inherits(Mavelous.CommStatusPopoverViewDelegate,Backbone.View);Mavelous.CommStatusPopoverViewDelegate.prototype.initialize=function(){this.packetLossModel=this.options.packetLossModel;this.packetLossModel.bind("change",this.render,this)};
Mavelous.CommStatusPopoverViewDelegate.prototype.popoverCreated=function(a){this.$el=a;this.$el.find(".popover-title").text(this.popoverTitle);this.render()};Mavelous.CommStatusPopoverViewDelegate.prototype.popoverDestroyed=function(){this.$el=null};Mavelous.CommStatusPopoverViewDelegate.prototype.render=function(){if(this.$el){var a=this.packetLossModel.getDelta(),a=this.packetLossString_(a);this.$el.find(".popover-content").html(a)}};
Mavelous.CommStatusPopoverViewDelegate.prototype.packetLossString_=function(a){return"In last "+a.period+"s, "+a.master_in+" packets received, "+a.master_out+" sent, "+a.mav_loss+" lost"};Mavelous.RadioButtonPopoverView=function(a){Backbone.View.call(this,a)};goog.inherits(Mavelous.RadioButtonPopoverView,Backbone.View);Mavelous.RadioButtonPopoverView.prototype.initialize=function(){var a=this;this.popoverViews=goog.array.map(this.options.popovers,function(b){goog.object.extend(b,{radioBtnController:a});return new Mavelous.PopoverView(b)})};goog.exportSymbol("Mavelous.RadioButtonPopoverView.prototype.initialize",Mavelous.RadioButtonPopoverView.prototype.initialize);
Mavelous.RadioButtonPopoverView.prototype.onButtonClick=function(a){a.selected()?a.deselect():(goog.array.map(this.popoverViews,function(a){a.selected()&&a.deselect()}),a.select())};goog.debug.RelativeTimeProvider=function(){this.relativeTimeStart_=goog.now()};goog.debug.RelativeTimeProvider.defaultInstance_=new goog.debug.RelativeTimeProvider;goog.debug.RelativeTimeProvider.prototype.set=function(a){this.relativeTimeStart_=a};goog.debug.RelativeTimeProvider.prototype.reset=function(){this.set(goog.now())};goog.debug.RelativeTimeProvider.prototype.get=function(){return this.relativeTimeStart_};goog.debug.RelativeTimeProvider.getDefaultInstance=function(){return goog.debug.RelativeTimeProvider.defaultInstance_};goog.debug.Formatter=function(a){this.prefix_=a||"";this.startTimeProvider_=goog.debug.RelativeTimeProvider.getDefaultInstance()};goog.debug.Formatter.prototype.showAbsoluteTime=!0;goog.debug.Formatter.prototype.showRelativeTime=!0;goog.debug.Formatter.prototype.showLoggerName=!0;goog.debug.Formatter.prototype.showExceptionText=!1;goog.debug.Formatter.prototype.showSeverityLevel=!1;goog.debug.Formatter.prototype.setStartTimeProvider=function(a){this.startTimeProvider_=a};
...
goog.debug.Console.show=function(){alert(goog.debug.Console.instance.logBuffer_)};goog.debug.Console.logToConsole_=function(a,b,c){if(a[b])a[b](c);else a.log(c)};Mavelous.App=function(){};
Mavelous.App.prototype.start=function(){(new goog.debug.Console).setCapturing(!0);var a=new goog.Uri(window.location.href);this.mavlinkAPI=new Mavelous.MavlinkAPI({url:"/mavlink/"});goog.isDef(a.getParameterValue("offline"))&&this.mavlinkAPI.useOfflineMode();a=a.getParameterValue("debug");if(goog.isDef(a)){window.console.log("Enabling debug mode");var b=document.getElementById("fps"),c=goog.dom.createDom("span",{id:"fpsvalue"});goog.dom.appendChild(b,c);goog.dom.appendChild(b,goog.dom.createTextNode(" fps"));
(new goog.debug.FpsDisplay).decorate(c);0<a.length&&(window.console.log("Enabling phonegap at http://debug.phonegap.com/client/#"+a),goog.net.jsloader.load("http://debug.phonegap.com/target/target-script-min.js#"+a))}this.pfdSettingsModel=new Mavelous.PFDSettingsModel;this.pfdView=new Mavelous.PFDView({mavlinkSrc:this.mavlinkAPI,settingsModel:this.pfdSettingsModel,drawingid:"pfdview",blockel:$("#pfdblock"),statel:$("#pfdstatus")});this.guideModel=new Mavelous.GuideModel({mavlinkSrc:this.mavlinkAPI});
this.guideAltView=new Mavelous.GuideAltitudeView({model:this.guideModel,input:$("#guidealt-input"),submit:$("#guidealt-submit"),text:$("#guidealt-text")});this.leafletDroneIcon=new Mavelous.LeafletDroneIconModel;this.leafletProviders=new Mavelous.LeafletProviders;this.vehicle=new Mavelous.VehicleLeafletPosition({mavlinkSrc:this.mavlinkAPI});this.panModel=new Mavelous.LeafletPanModel({vehicle:this.vehicle});this.panCtrl=new Mavelous.LeafletPanControlView({model:this.panModel,button:$("#mapoverlay-btn-centermap"),
icon:$("#mapoverlay-icon-centermap")});this.mapView=new Mavelous.LeafletView({vehicle:this.vehicle,provider:this.leafletProviders,vehicleIcon:this.leafletDroneIcon,guideModel:this.guideModel,panModel:this.panModel});this.commStatusModel=new Mavelous.CommStatusModel({mavlinkSrc:this.mavlinkAPI});this.packetLossModel=new Mavelous.PacketLossModel({mavlinkSrc:this.mavlinkAPI});this.commStatusButtonView=new Mavelous.CommStatusButtonView({commStatusModel:this.commStatusModel,packetLossModel:this.packetLossModel,
el:$("#navbar-btn-link")});this.gpsButtonView=new Mavelous.GpsButtonView({mavlinkSrc:this.mavlinkAPI,el:$("#navbar-btn-gps")});this.statustextView=new Mavelous.StatustextView({mavlinkSrc:this.mavlinkAPI});this.modeStringView=new Mavelous.ModeStringView({mavlinkSrc:this.mavlinkAPI,el:$("#pfd_modestringview")});this.flightModeModel=new Mavelous.FlightModeModel({mavlinkSrc:this.mavlinkAPI});this.flightCommandModel=new Mavelous.CommandLongModel({mavlinkSrc:this.mavlinkAPI});this.flightModeButtonView=
new Mavelous.FlightModeButtonView({el:$("#navbar-btn-mode"),modeModel:this.flightModeModel});this.statusButtons=new Mavelous.RadioButtonPopoverView({popovers:[{btn:this.gpsButtonView,delegate:new Mavelous.GpsPopoverViewDelegate({mavlinkSrc:this.mavlinkAPI})},{btn:this.commStatusButtonView,delegate:new Mavelous.CommStatusPopoverViewDelegate({packetLossModel:this.packetLossModel})},{btn:this.flightModeButtonView,delegate:new Mavelous.FlightModePopoverViewDelegate({modeModel:this.flightModeModel,commandModel:this.flightCommandModel})}]});
this.batteryButton=new Mavelous.BatteryButton({mavlinkSrc:this.mavlinkAPI,el:$("#navbar-btn-battery")});this.settingsView=new Mavelous.SettingsView({map:this.mapView.map,mapView:this.mapView,mapProviderModel:this.leafletProviders,vehicleIconModel:this.leafletDroneIcon,modalToggle:$("#navbar-a-settings"),modal:$("#settings-modal"),mapProviderPicker:$("#settings-mapproviderpicker"),mapZoomSlider:$("#settings-mapzoom"),mapZoomValue:$("#settings-mapzoom-value"),mapPathPicker:$("#settings-mappathpicker"),
vehicleIconPicker:$("#settings-vehicleiconpicker"),pfdSettingsModel:this.pfdSettingsModel,pfdPositionLeft:$("#settings-pfdpos-left"),pfdPositionRight:$("#settings-pfdpos-right"),pfdPositionUp:$("#settings-pfdpos-up"),pfdPositionDown:$("#settings-pfdpos-down")});this.router=new Mavelous.AppRouter({pfdSettingsModel:this.pfdSettingsModel});Backbone.history.start();767<$(window).width()?this.router.navigate("overview",{trigger:!0}):this.router.navigate("maponly",{trigger:!0});var d=null,e=new goog.async.Throttle(function(){this.mavlinkAPI.update();
d.start()},100,this),d=new goog.async.AnimationDelay(function(){e.fire()});d.start()};goog.exportSymbol("Mavelous.App",Mavelous.App);goog.exportSymbol("Mavelous.App.prototype.start",Mavelous.App.prototype.start);
